...
func (j *jsiiProxy_KubeProxyAddon) PodIdentityAssociations() interface{} {
...
func (j *jsiiProxy_KubeProxyAddon)SetPodIdentityAssociations(val interface{}) {
...
func KubeProxyAddon_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeProxyAddon_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
