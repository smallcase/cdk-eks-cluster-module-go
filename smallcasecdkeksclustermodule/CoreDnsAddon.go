...
func (j *jsiiProxy_CoreDnsAddon) PodIdentityAssociations() interface{} {
...
func (j *jsiiProxy_CoreDnsAddon) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CoreDnsAddon)SetPodIdentityAssociations(val interface{}) {
...
func (j *jsiiProxy_CoreDnsAddon)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CoreDnsAddon_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCoreDnsAddon_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
