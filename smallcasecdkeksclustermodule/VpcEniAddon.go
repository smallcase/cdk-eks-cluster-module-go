...
func (j *jsiiProxy_VpcEniAddon) PodIdentityAssociations() interface{} {
...
func (j *jsiiProxy_VpcEniAddon) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_VpcEniAddon)SetPodIdentityAssociations(val interface{}) {
...
func (j *jsiiProxy_VpcEniAddon)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func VpcEniAddon_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpcEniAddon_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
